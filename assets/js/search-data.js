...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Projects",
          description: "Selected research and engineering projects.精选研究与工程项目。",
          section: "Navigation",
          handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-joined-mondo-tech-妙动科技-in-shenzhen-as-a-vla-algorithm-intern-working-on-vision-language-action-models-for-robotic-manipulation-加入深圳妙动科技-mondo-tech-担任-vla-算法实习生-从事面向机器人操作的视觉-语言-动作模型研发",
          title: '💼 Joined Mondo Tech (妙动科技) in Shenzhen as a VLA Algorithm Intern, working...',
          description: "",
